...
- Lógica de Abandono y Transiciones: Al cambiar un libro al estado de Abandonado, el sistema calcula las fechas correspondientes y permite al lector registrar el número exacto de páginas leídas hasta ese momento, datos que se conservan de forma aislada para no alterar el cómputo de páginas de la ficha técnica original del libro.
